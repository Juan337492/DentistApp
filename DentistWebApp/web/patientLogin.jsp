...
<html>
    ...
    <h1 class="loginHeader"> Patient Login </h1>
    <div class="loginPrompt">
        <form action="http://localhost:8080/DentistWebApp/patientLoginServlet" method="post" accept-charset="utf-8" class="loginForm" >
